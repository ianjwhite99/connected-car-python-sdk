...
class TestVehicle(unittest.TestCase):
    ...
    def test_get_vehicle_info(self):
        ...
        responses.add('GET', const.VEHICLE_URL + '/vinlookup/v1/vins/' +
                      self.vin + '/detail?country=USA&language=EN', json=data)
    ...
    def test_send_auth(self):
        responses.add('POST', const.API_URL + '/vehicles/v2/' +
                      self.vin + '/drivers', json={})
    ...
    def test_auth_status(self):
        ...
        responses.add('GET', const.API_URL + '/vehicles/' + self.vin +
                      '/authstatus?lrdt=01-01-1970%2000:00:00', json=data)
    ...
    def test_get_capability(self):
        ...
        responses.add('GET', const.API_URL +
                      '/capability/v1/vehicles/' + self.vin, json=data)
